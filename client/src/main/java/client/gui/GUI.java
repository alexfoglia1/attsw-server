...
import client.GridFromServer;
import client.IClient;
import client.RestServiceClient;
...
public class GUI {
	...
	public static final String SERVER_UNREACHEABLE = "Error, server is unreacheable";
	...
	public void createConnection(String host, String port) {
		...
		cl = new Client(rsc);
		boolean ok = cl.tryConnection();
		if (ok) {
			alert(OPERATION_OK);
			connCreated = true;
		} else {
			alert(SERVER_UNREACHEABLE);
			connCreated = false;
		}
	}
