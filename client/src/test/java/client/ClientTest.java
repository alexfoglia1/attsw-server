...
public class ClientTest {
	...
	@Before
	public void setUp() {
		client=new Client(service=Mockito.mock(IRestServiceClient.class));
	}

	@Test
	public void testTryConnectionWhenServerIsAlive() {
		assertTrue(client.tryConnection());
	}
	
	@Test
	public void testTryConnectionWhenServerIsNotAlive() throws IOException {
		Mockito.doThrow(new IOException()).when(service).doGet(1, "");
		assertFalse(client.tryConnection());
	}
